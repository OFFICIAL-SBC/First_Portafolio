...
class CountryApiRepository(
    ...
    suspend fun getCountryNearToALocation(location: String, radio: Int): Resource<CityList>{
        return safeApiCall { dataSourceApiTwo.getCitiesNearToALocation(location, radio) }
    }
}